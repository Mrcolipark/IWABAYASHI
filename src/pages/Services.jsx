    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-gray-100 pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-center gap-6">
            ...
            >
              ...
              <span>{t('services.currentBusiness.title')}</span>
            </button>
            <button
            ...
            >
              <span className="text-2xl">🚢</span>
              <span>{t('services.futureBusiness.title')}</span>
            </button>
          </div>
        </div>
      </section>
                  ...
                  <div className="space-y-8">
                    <div>
                      ...
                      <p className="text-lg text-gray-600 leading-relaxed mb-8">
                        {t('services.currentBusiness.services.0.description')}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {t('services.currentBusiness.services.0.features', { returnObjects: true }).map((feature, i) => (
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {t('services.currentBusiness.services.0.advantages', { returnObjects: true }).map((advantage, i) => (
                    ...
                    <div className="pt-6">
                      <Link
                        to="/contact"
                        onClick={() => trackEvent('service_cta_clicked', { service: 'health_products' })}
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="space-y-8">
                    <div>
                      ...
                      <p className="text-lg text-gray-600 leading-relaxed mb-8">
                        {t('services.futureBusiness.services.0.description')}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {t('services.futureBusiness.services.0.features', { returnObjects: true }).map((feature, i) => (
                          <div key={i} className="flex items-center space-x-3 p-4 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-300 shadow-sm">
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {t('services.futureBusiness.services.0.advantages', { returnObjects: true }).map((advantage, i) => (
                    ...
                    <div className="pt-6">
                      <Link
                        to="/contact"
                        onClick={() => trackEvent('future_service_inquiry_clicked', { service: 'export_business' })}
                      ...
                      >
                        {t('services.cta.partnershipInquiry')}
                      </Link>
                    </div>
                  </div>
                    ...
                    <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg">
                      ...
                      <div className="text-center mb-8">
                        ...
                        <div className="space-y-6">
                          {t('services.futureBusiness.services.0.timeline', { returnObjects: true }).map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h3 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
              {t('services.serviceCapabilities.title')}
            </h3>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {t('services.serviceCapabilities.description')}
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {t('services.serviceCapabilities.capabilities', { returnObjects: true }).map((capability, index) => (
      ...
      <section className="py-16 bg-gradient-to-r from-gray-800 to-green-800">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h3 className="text-3xl font-bold text-white mb-6">{t('services.cta.title')}</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            >
              {t('services.cta.consultServices')}
            </Link>
            <Link
              to="/about"
