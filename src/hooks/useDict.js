...
export const useDict = () => {
  ...
  return {
    // SEO元数据
    meta: {
      title: t('about.companyInfo.name', '岩林株式会社') + ' - 专业的中日贸易综合服务商',
    ...
    services: {
        ...
        services: [
          {
            title: "日本保健品进口代理",
            status: "进行中",
            description: "依托日本先进的生产工艺与严格的品质标准，我们精心甄选优质保健品，致力于为中国消费者引入安全、健康、可信赖的产品，满足日益增长的健康消费需求。",
            features: [
              "严格的品质甄选标准",
              "完善的进口代理服务",
              "专业的市场咨询支持",
        ...
        services: [
          {
            title: "中国大宗商品出口拓展",
            status: "规划中",
            description: "未来我们将依托中国丰富的产业基础和优质的商品资源，积极布局大宗商品出口业务，助力更多优质中国产品进入日本市场，为两国的经贸合作注入新动力。",
            features: [
              "丰富的产业基础资源",
              "优质的商品资源整合",
              "专业的市场开拓能力",
      ...
      serviceCapabilities: {
        ...
        capabilities: [
          {
            name: "专业市场咨询",
            description: "提供深度的市场分析和专业咨询服务"
          },
          {
            name: "灵活供应链管理", 
            description: "建立高效、灵活的供应链管理体系"
          },
          {
            name: "高效进出口服务",
            description: "提供一站式进出口贸易服务解决方案"
          }
        ]
      }
    },
    ...
    contact: {
      ...
      info: {
        company: t('about.companyInfo.name'),
